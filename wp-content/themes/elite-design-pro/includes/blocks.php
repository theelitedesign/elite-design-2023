...
function glide_theme_acf_init() {
	...
	if ( function_exists( 'acf_register_block' ) ) {
		...
		// Register a block - Blog Post

		acf_register_block(
			array(
				'name'            => 'blog-teaser',
				'title'           => __( 'Blog Teaser', 'elitedesign_td' ),
				'description'     => __( 'A custom Blog Teaser.', 'elitedesign_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => '<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path fill-rule="evenodd" clip-rule="evenodd" d="M60 40H40V60H60V40ZM36 36V64H64V36H36Z" fill="#A50A09"/>
				...
				'mode'            => 'edit',
				'keywords'        => array( 'blog','post', 'teaser' ),
				'align'           => 'wide',
				'supports'        => array(
					'align'           => false
				),
		...
		// Register a block - scroller

		acf_register_block(
			array(
				'name'            => 'informer',
				'title'           => __( 'informer', 'elitedesign_td' ),
				'description'     => __( 'A custom informer.', 'elitedesign_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => '<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path fill-rule="evenodd" clip-rule="evenodd" d="M60 40H40V60H60V40ZM36 36V64H64V36H36Z" fill="#A50A09"/>
